...
function(apply_buildkit)
  ...
  # Prefer the sing-box core module when present; it produces the same
  # FlClashCore output the app bundles and launches.
  if(EXISTS "${PROJECT_ROOT}/core-singbox/go.mod")
    find_program(GO_EXECUTABLE go REQUIRED)
    add_custom_command(
      OUTPUT ${_output}
      COMMAND ${CMAKE_COMMAND} -E env CGO_ENABLED=0
      ${GO_EXECUTABLE} build -tags with_clash_api -ldflags "-w -s"
      -o ${_output} .
      WORKING_DIRECTORY "${PROJECT_ROOT}/core-singbox"
      COMMENT "Building sing-box core..."
      VERBATIM
    )
  else()
    add_custom_command(
