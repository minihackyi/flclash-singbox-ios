...
class AppPath {
  ...
  AppPath._internal() {
    ...
    getApplicationSupportDirectory().then((value) {
      // Isolate debug instances from the installed app: a shared home dir
      // clashes on the single-instance lock, database and profiles.
      dataDir.complete(
        kDebugMode ? Directory(join(value.path, 'debug')) : value,
      );
    });
