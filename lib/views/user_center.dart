...
class UserCenterView extends ConsumerStatefulWidget {
  const UserCenterView({super.key});

  @override
  ConsumerState<UserCenterView> createState() => _UserCenterViewState();
}

class _UserCenterViewState extends ConsumerState<UserCenterView> {
  bool _syncing = false;
  ...
  Future<void> _logout() async {
    ...
    if (!mounted) return;
    context.showNotifier('已退出登录，请重新登录');
  }
